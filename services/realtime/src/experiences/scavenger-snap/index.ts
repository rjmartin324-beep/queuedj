...
const SNAP_CHALLENGES = [
  ...
  // ── added to reach 100 ───────────────────────────────────────────────────────
  "Find something that is both sharp and soft at the same time",
  "Show us the most colourful thing near you",
  "Find something that is technically a tool but looks like it isn't",
  "Show us your best attempt at a wax museum pose",
  "Find something that is clearly past its prime",
  "Show us a piece of paper that has something written on it you didn't write",
  "Find something that would survive a zombie apocalypse",
  "Show us the most dramatic shadow you can create",
  "Show your most impressive tower built from whatever is near you",
  "Find something that is the exact same colour as your shirt",
  "Show us your best impression of a real estate listing photo",
  "Find something that is aggressively average",
  "Show us the most dangerous-looking object that is completely harmless",
  "Find something with an interesting texture and photograph it up close",
  "Show us your best candid photo of someone who is clearly not candid",
  "Find something that looks like it belongs in a different decade",
  "Show us the most honest photo of your current mood",
  "Find something that has been repaired badly but is still in use",
  "Show us the most dramatic empty space near you",
  "Find something that represents your personality in three seconds",
  "Show us your best 'before' photo for a home renovation show",
  "Find something that is exactly the right size for something else near it",
  "Show us the most suspicious object within 2 metres of you",
  "Find something that is clearly being held together by the wrong thing",
  "Show us the best 'accidental art' in the room",
  "Find the most official-looking thing near you",
  "Show us something that would make a terrible gift but is genuinely useful",
  "Find something that is clearly older than you but still being used",
  "Show the best architectural detail in the room you hadn't noticed before",
  "Find something that proves someone here has very specific taste",
  "Show us the most aggressively branded object near you (any logo)",
  "Find something that looks like it was placed there very intentionally",
  "Show us your best overhead flat-lay of what's in front of you",
  "Find something that makes absolutely no sense being here",
  "Show us your best attempt at a dramatic product reveal photo",
  "Find something that looks expensive but probably isn't",
  "Find something that clearly has not moved in at least a month",
  "Show us the most unnecessarily complicated object near you",
  "Find something that has served its purpose and retired gracefully",
  "Show us your best 'stock photo' pose — arms crossed, smiling, confident",
  "Find something that looks like it escaped from somewhere",
  "Show us the most satisfying right angle in the room",
  "Find something that is waiting for someone to notice it",
  "Show us something that is perfect just as it is",
  "Find something that belongs to two different categories at once",
  "Show us the room from the perspective of the floor",
  "Find something that contains multitudes (caption required)",
  "Show us your best attempt at making something mundane look cinematic",
  "Find the item with the most sentimental value to its owner (they must confirm)",
];
