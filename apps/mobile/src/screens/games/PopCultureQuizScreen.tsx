...
const QUESTIONS = [
  ...
  { q: "Which artist released the album 'Renaissance' in 2022?", opts: ["Rihanna", "Beyoncé", "Lizzo", "SZA"], a: 1, category: "Music" },
  { q: "What Netflix show features the Upside Down?", opts: ["Dark", "Stranger Things", "The OA", "Haunting of Hill House"], a: 1, category: "TV" },
  { q: "Which film won Best Picture at the 2020 Oscars?", opts: ["1917", "Joker", "Parasite", "The Irishman"], a: 2, category: "Film" },
  { q: "What is Doja Cat's real first name?", opts: ["Amala", "Kayla", "Jasmine", "Destiny"], a: 0, category: "Music" },
  { q: "Which show popularised the phrase 'We were on a break!'?", opts: ["Seinfeld", "How I Met Your Mother", "Friends", "The Office"], a: 2, category: "TV" },
  { q: "What year did Instagram launch?", opts: ["2008", "2009", "2010", "2012"], a: 2, category: "Social" },
  { q: "Who played the Joker in the 2019 film 'Joker'?", opts: ["Christian Bale", "Heath Ledger", "Joaquin Phoenix", "Jared Leto"], a: 2, category: "Film" },
  { q: "Which song by Olivia Rodrigo has the lyric 'I'm so sick of seventeen'?", opts: ["good 4 u", "drivers license", "traitor", "brutal"], a: 3, category: "Music" },
  { q: "What show features contestants on a remote island voting each other off?", opts: ["The Amazing Race", "Big Brother", "Survivor", "Fear Factor"], a: 2, category: "TV" },
  { q: "Which artist has the most monthly Spotify listeners of all time?", opts: ["Drake", "Ed Sheeran", "Taylor Swift", "The Weeknd"], a: 2, category: "Music" },
  { q: "In which film does the line 'Why so serious?' appear?", opts: ["Batman Begins", "The Dark Knight", "Suicide Squad", "Batman v Superman"], a: 1, category: "Film" },
  { q: "What does 'IMO' stand for in texting?", opts: ["In My Opinion", "In Most Orders", "I'm Moving On", "Initial Message Out"], a: 0, category: "Social" },
  { q: "Which rapper's real name is Aubrey Graham?", opts: ["Kendrick Lamar", "J. Cole", "Drake", "Future"], a: 2, category: "Music" },
  { q: "What show is set in Hawkins, Indiana?", opts: ["Outer Banks", "Riverdale", "Stranger Things", "Euphoria"], a: 2, category: "TV" },
  { q: "Which superhero is known as the 'Caped Crusader'?", opts: ["Superman", "Batman", "Iron Man", "Thor"], a: 1, category: "Film" },
  { q: "What year did TikTok launch globally outside China?", opts: ["2016", "2017", "2018", "2019"], a: 2, category: "Social" },
  { q: "Which artist released 'Bad Guy'?", opts: ["Ariana Grande", "Dua Lipa", "Billie Eilish", "Halsey"], a: 2, category: "Music" },
  { q: "In Breaking Bad, what is Walter White's alias?", opts: ["The Cook", "Heisenberg", "El Diablo", "Mr White"], a: 1, category: "TV" },
];
