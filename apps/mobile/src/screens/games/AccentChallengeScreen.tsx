    ...
    <LinearGradient colors={["#03001c","#001a10"]} style={s.flex}>
      <SafeAreaView style={s.flex}>
        <View style={s.center}>
          ...
          <Text style={s.title}>Mic Drop!</Text>
          <Text style={s.bigScore}>{score}</Text>
          <Text style={s.label}>ACCENT POINTS</Text>
          <TouchableOpacity style={s.btn} onPress={startGame}><LinearGradient colors={["#b5179e","#7209b7"]} style={s.btnI}><Text style={s.btnT}>MORE ACCENTS</Text></LinearGradient></TouchableOpacity>
